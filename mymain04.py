...
class K0sK0sFilter:
    ...
    # methods
    # add adds an event to the event set
    def add( self, event ):
    ...
    def recordPionData( self ):
        ...
        for pion_group in self.event_pions:
...
# after event generation, record data
ef.recordPionData()
...
print( "Number of valid K0sK0s -> pi+pi-pi+pi- events: " + str( len( ef.event_pions ) ) )
print( "length of event set: " + str( len( ef.event_set ) ) )
print( "Number of invalid pion groups: " + str( ef.test_count ) )
